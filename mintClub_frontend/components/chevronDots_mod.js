...
function ChevronDots({
  ...
  let progressClass = `absolute top-1/2 left-0 h-1 transform -translate-y-1/2 
      bg-blue-400 transition-width ease-in-out duration-500`
  ...
  return (
    <div className={finalClass} {...newProps}>
      ...
      <div className="mt-3 relative sm:block">{Steps}</div>
    </div>
  )
}
