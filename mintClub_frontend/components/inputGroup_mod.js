...
function InputGroup({
  ...
  const finalClass = `${className} w-full border border-gray-300 rounded-lg px-4 py-3 outline-none transition-colors duration-150 ease-in-out focus:border-blue-400 ${
